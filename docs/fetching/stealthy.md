...
|     wait_until      | When page navigation is considered complete. Accepts `commit`, `domcontentloaded`, `load`, or `networkidle`. Defaults to `load`.                                                                                                   |    ✔️    |
