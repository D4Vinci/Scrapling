"""Test async cookie handling in browser sessions.

This module tests the improved async cookie handling functionality that ensures
...
from scrapling.fetchers.stealth_chrome import AsyncStealthyFetcher


class TestAsyncCookieHandling:
    """Test async cookie validation and injection into browser contexts."""
    ...
    @pytest.mark.asyncio
    async def test_basic_cookie_creation(self):
        """Test that async session accepts and validates basic cookie format."""
        cookies = [
            {
                "name": "test_cookie",
                "value": "test_value",
    ...
    async def test_multiple_cookies(self):
        """Test that async session handles multiple cookies correctly."""
        cookies = [
    ...
    @pytest.mark.asyncio
    async def test_cookie_without_optional_fields(self):
    ...
    @pytest.mark.asyncio
    async def test_invalid_cookie_format_raises_error(self):
    ...
    @pytest.mark.asyncio
    async def test_non_dict_cookie_raises_error(self):
    ...
    @pytest.mark.asyncio
    async def test_empty_cookies_list(self):
    ...
    @pytest.mark.asyncio
    async def test_none_cookies(self):
    ...
    @pytest.mark.asyncio
    async def test_cookie_persistence_across_requests(self):
        """Test that cookies persist across multiple requests in the same async session."""
        cookies = [
        ...
        async with AsyncStealthySession(
            ...
            # Make first request
            response1 = await session.async_fetch(self.status_200)
            assert response1.status == 200

            # Make second request in same session
            response2 = await session.async_fetch(self.status_200)
    ...
    @pytest.mark.asyncio
    async def test_fetcher_with_cookies(self):
        """Test that AsyncStealthyFetcher accepts cookies properly."""
        cookies = [
    ...
    @pytest.mark.asyncio
    async def test_cookie_with_url_attribute(self):
    ...
    @pytest.mark.asyncio
    async def test_cookie_with_expires_attribute(self):
    ...
    @pytest.mark.asyncio
    async def test_mixed_valid_and_invalid_cookies(self):
        """Test that async session handles mixed valid/invalid cookies appropriately."""
    ...
    @pytest.mark.asyncio
    async def test_samesite_values(self):
